...
fr = open('./csv/film_characters.csv', 'r')
for line in fr:
    tmp = json.loads(line.strip('\n'))
    characters.append(tmp)
fr.close()

fr = open('./csv/film_planets.csv', 'r')
for line in fr:
    tmp = json.loads(line.strip('\n'))
    planets.append(tmp)
fr.close()

fr = open('./csv/film_starships.csv', 'r')
for line in fr:
    tmp = json.loads(line.strip('\n'))
    starships.append(tmp)
fr.close()

fr = open('./csv/film_vehicles.csv', 'r')
for line in fr:
    tmp = json.loads(line.strip('\n'))
    vehicles.append(tmp)
fr.close()

fr = open('./csv/film_species.csv', 'r')
for line in fr:
    tmp = json.loads(line.strip('\n'))
    species.append(tmp)
fr.close()
